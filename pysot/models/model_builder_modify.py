...
class ModelBuilder(nn.Module):
    ...
    def forward(self, data):
        ...
        print("zf shape is ",zf[0].shape)
        xf = self.backbone(search)
        print("xf shape is ",xf[0].shape)
        if cfg.MASK.MASK:
            zf = zf[-1]
            self.xf_refine = xf[:-1]
            xf = xf[-1]
...
data={}
data['template']=torch.ones((32,3,127,127))
data['search']=torch.ones((32,3,127,127))
