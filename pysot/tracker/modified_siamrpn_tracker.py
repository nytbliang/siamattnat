...
class Modified_SiamRPNTracker(SiameseTracker):
    ...
    def track(self, img, zf):
        ...
        self.center_pos_list[1]=np.array([cx_list[1],cx_list[1]])
        self.size_list[1]=np.array([width_list[1], height_list[1]])
        
        self.center_pos_list[2]=np.array([cx_list[2],cx_list[2]])
        self.size_list[2]=np.array([width_list[2], height_list[2]])
        ...
        best_score_list=[]
        best_score_list.append(score_list[0][best_idx_list[0]])
        best_score_list.append(score_list[1][best_idx_list[1]])
        best_score_list.append(score_list[2][best_idx_list[2]])
        return {
                'bbox': bbox,
